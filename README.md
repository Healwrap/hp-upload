...
1. **小文件秒传**、这部分要求能够上传任意文件，但是如果是过大的文件如大于20M的文件，使用分片上传
...
小文件上传的话，可以直接使用XHR上传，因此只需要封装上传接口即可，在上传时获取到上传速度和进度即可

![image-20240731231813550](https://picgo-img-repo.oss-cn-beijing.aliyuncs.com/img/568f1fb82e0438acf1169dce2f93eaf3.png)

更多代码见：[hp-upload/src/main.ts at master · Healwrap/hp-upload (github.com)](https://github.com/Healwrap/hp-upload/blob/master/src/main.ts)
